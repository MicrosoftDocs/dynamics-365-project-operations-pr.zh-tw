...
## <a name="install-project-service"></a>安裝 Project Service  
 [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] 是偏好的解決方案。 有幾種方式可購買解決方案。 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)][讓您的組織和使用者開始使用](../admin/onboard-your-organization-and-users-to-dynamics-365-online.md)。  
...
- [開始進行應用程式製作及自訂](../customize/getting-started-customization.md)  
  
- [建立及設計表單](../customize/create-design-forms.md)  
  
- [建立和編輯儀表板](../customize/create-edit-dashboards.md)  
  
- [建立和編輯程序](../customize/guide-staff-through-common-tasks-processes.md)  
  
- [報表與分析簡介](../analytics/reporting-analytics-with-dynamics-365.md)  
